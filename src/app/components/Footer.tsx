          ...
          <div className="grid md:grid-cols-[1.5fr_1fr] gap-20 mb-32">
            ...
            <div>
              ...
              <div className="flex flex-col gap-10">
                 ...
                 >
                   ...
                   <div>
                     <span className="block text-4xl font-light tracking-tighter text-white group-hover:translate-x-2 transition-transform duration-300">Iniciar um Projeto</span>
                     <span className="block text-sm font-mono uppercase tracking-widest text-neutral-500 mt-1 group-hover:text-neutral-400 transition-colors">Disponível para novos projetos</span>
                   </div>
                 </button>

                 <a href="mailto:joaovitor.mizeeski@gmail.com" className="group flex items-center gap-4 text-lg font-mono text-neutral-500 hover:text-white transition-colors pl-4">
                   <span className="w-2 h-2 rounded-full bg-green-500" />
                   joaovitor.mizeeski@gmail.com
                 </a>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-end gap-12">
              <div className="grid grid-cols-2 gap-12">
                <div>
                  <h4 className="font-mono text-xs uppercase tracking-widest text-neutral-500 mb-6">Redes</h4>
                  <ul className="space-y-4">
                    {[
                      { name: 'LinkedIn', href: 'https://www.linkedin.com/in/joao-mizeeski' },
                      { name: 'Behance', href: 'https://www.behance.net/joovimizeesk' },
                    ].map((social) => (
                      <li key={social.name}>
          ...
          >
            ...
            {formState === 'success' ? (
              <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-3xl font-medium mb-2">Mensagem Enviada</h3>
                <p className="text-neutral-400 font-light">Entrarei em contato em breve.</p>
              </div>
            ) : (
              <div className="mt-12">
                <span className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-6 block">04 / Contato</span>
                <h3 className="text-4xl md:text-5xl font-medium tracking-tighter mb-2">
                  Iniciar um <br />
                  <span className="italic font-serif text-neutral-500">Projeto</span>
                </h3>
                <p className="text-neutral-400 font-light mb-12">
                  Fale sobre sua visão. Vamos construir juntos.
                </p>
