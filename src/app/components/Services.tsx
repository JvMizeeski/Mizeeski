...
import { Layout, Brain, Database, Globe, Layers, Search } from 'lucide-react';

const services = [
  {
    icon: Layout,
    title: "UX / UI Design",
    description: "Ciclo completo de design: discovery, fluxos, wireframes, protótipos navegáveis e interfaces em alta fidelidade com foco em usabilidade."
  },
  {
    icon: Brain,
    title: "Behavioral Design",
    description: "Interfaces baseadas em neurociência e ciência comportamental — arquitetura de escolha, redução de carga cognitiva e tomada de decisão."
  },
  {
    icon: Layers,
    title: "Design Systems",
    description: "Criação e evolução de sistemas de design modulares (Atomic Design) para consistência visual e escalabilidade de produto."
  },
  {
    icon: Search,
    title: "Pesquisa & Discovery",
    description: "Pesquisas qualitativas e quantitativas, testes de usabilidade, análise de dados e validação contínua com usuários reais."
  }
];
        ...
        <div className="mb-32 grid md:grid-cols-2 gap-16 items-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-light text-neutral-300 leading-relaxed">
              Combinando rigor científico com estética precisa para construir produtos digitais que transformam comportamento e entregam resultados reais.
            </p>
          </motion.div>
        </div>
