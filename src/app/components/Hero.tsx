  ...
  return (
    <section ref={containerRef} className="relative h-screen flex items-center justify-center overflow-hidden px-6 bg-neutral-950">
      ...
      >
        ...
        >
          Behavioral <br />
          <span className="italic font-serif text-neutral-500">Design</span>
        </motion.h1>
        ...
        >
          <p className="md:text-right flex-1 leading-relaxed">
            Interfaces construídas com base em<br />
            ciência do comportamento e neurociência.
          </p>
          <div className="w-px h-16 bg-white/10 hidden md:block" />
          <p className="md:text-left flex-1 leading-relaxed">
            UX/UI Designer em Palhoça, SC —<br />
            atuando no Brasil e mercado europeu.
          </p>
        </motion.div>
      </motion.div>
